...
router.post('/address', async (req, res)=>{
    try{
        ...
        logger.error(`Address API -- Something went wrong in create address: ${err.message}`)
...
router.get('/address/get/:id', async (req, res)=>{
    try{
        ...
        logger.error(`Address API -- Something went wrong in read address: ${err.message}`)
    }
...
router.patch('/address/:id', async (req, res)=>{
    try{
        ...
        logger.error(`Address API -- Something went wrong in update address: ${err.message}`)
        return res.status(500).send('Something went wrong')
    }
...
router.delete('/address/:id', async(req, res)=>{
    try{
        ...
        logger.error(`Address API -- Something went wrong trying to delete address: ${err.message}`)
    }
