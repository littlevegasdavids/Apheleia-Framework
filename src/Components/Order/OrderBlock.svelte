...
<div class="bg-primary-content outline outline-black outline-1 grid grid-rows-2 p-3 rounded-lg gap-2">
    ...
    <button class="btn btn-primary rounded-md btn-sm shadow-lg tablet:w-6/12 tablet:mx-auto" on:click={()=>window.location.href=`/order/${order.id}`}>View Order<i class="fa-solid fa-eye fa-lg pl-2"></i></button>
</div>